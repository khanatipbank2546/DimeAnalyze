        ...
        current: [
            {
                ...
                details: "ช่วยคลายคอขวดซัพพลายเชน ส่งผลให้ยอดส่งมอบ Blackwell เพิ่มขึ้นในไตรมาสถัดไป ดันรายได้กลุ่มบริษัท AI ของสหรัฐฯ ขึ้นยกแผง"
            },
            {
...
function updateInsightText() {
    ...
    if (currentFilter === 'all') {
        text = isSurge 
            ? 'ภาพรวมตลาดรวมอยู่ในสภาวะพุ่งทะยาน (Surge) นำโดยหุ้นกลุ่มโครงสร้างพื้นฐาน AI และธุรกิจอวกาศที่ได้รับเงินลงทุนล้นหลาม สภาพคล่องไหลเข้าสินทรัพย์เสี่ยงสูงในระดับสูงสุดในรอบปี' 
        ...
        text = isSurge
            ? 'กลุ่มเทคโนโลยีขยายตัวแรงเป็นประวัติการณ์ ได้รับแรงขับเคลื่อนหลักจากดีมานด์ชิปประมวลผล Blackwell และงบลงทุนคลาวด์มหาศาลจากลูกค้าระดับองค์กร'
        ...
        text = isSurge
            ? 'หุ้นอวกาศทะยานพุ่งแรงสูงสุดขีด ขานรับความสำเร็จการลงจอดดวงจันทร์ของ LUNR และความคืบหน้าเชิงพาณิชย์ของ AST SpaceMobile ในการส่งต่อสัญญาณ 5G บรอดแบนด์'
        ...
        text = isSurge
            ? 'หุ้นทรัพยากรแห่งอนาคตขยับตัวขึ้นร้อนแรงตามความต้องการโลหะทองแดงในสายส่งกำลังไฟและระบบระบายความร้อน และความคืบหน้านโยบายจัดซื้อแร่หายากเชิงความมั่นคง'
        ...
        text = isSurge
            ? 'กลุ่มโครงสร้างพื้นฐานและเครื่องจักรผลิตชิปขั้นสูงพุ่งตัวรุนแรงตามระดับการจองชิป 2nm/3nm เต็มล่วงหน้า และระบบระบายความร้อนดาต้าเซ็นเตอร์ของ Vertiv ที่มียอดขายประวัติศาสตร์'
